      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col justify-center">
        <div className="mx-auto w-full max-w-7xl px-5 md:px-6">
          <div className="w-full max-w-2xl text-left">
            {/* Headline */}
            <h1
              className="font-display text-4xl font-extrabold leading-[1.1] tracking-tight text-white md:text-6xl lg:text-6xl"
              style={fadeIn(160)}
            >
              Main Lebih Mudah
              <br />
            ...
            {/* Subtext */}
            <p
              className="mt-5 text-base leading-relaxed text-slate-200 md:text-lg max-w-xl"
              style={fadeIn(240)}
            >
              Booking lapangan favoritmu sekarang, pilih jadwal dan langsung
              main tanpa ribet.
            </p>

            {/* Sport category pills */}
            <div className="mt-8 flex flex-wrap gap-2" style={fadeIn(310)}>
              {sports.map((s) => (
                <span
                  key={s}
            ...
            {/* Stats */}
            <div className="mt-12 flex flex-wrap gap-8" style={fadeIn(450)}>
              {[
                { value: "4", label: "Lapangan Aktif" },
                { value: "100+", label: "Booking/Bulan" },
                { value: "4.8★", label: "Rating Gmaps" },
              ].map(({ value, label }) => (
